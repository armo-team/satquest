<section class="py-16 md:py-24 bg-gray-50">
  <div class="container mx-auto px-4 sm:px-6">
    ...
    <div class="grid md:grid-cols-3 gap-8 mt-12">
      ...
      <div class="relative">
        ...
        <div class="bg-white p-6 md:p-8 pt-12 rounded-xl shadow-md border border-gray-100 h-full relative z-0 hover:shadow-lg transition-shadow duration-300">
          ...
          <h3 class="text-xl font-bold text-blue-900 mb-3 text-center">Find an Issue</h3>
          ...
          <div class="mt-4 text-sm text-gray-500">
            <span class="block">• Browse by programming language</span>
            <span class="block">• Filter by difficulty level</span>
            <span class="block">• Sort by bounty amount</span>
          </div>
        </div>
      </div>
      ...
      <div class="relative">
        ...
        <div class="bg-white p-6 md:p-8 pt-12 rounded-xl shadow-md border border-gray-100 h-full relative z-0 hover:shadow-lg transition-shadow duration-300">
          <div class="text-center mb-6">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 md:h-16 md:w-16 mx-auto text-accent-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M8 9l3 3-3 3m5 0h3M5 20h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
            </svg>
          </div>
          <h3 class="text-xl font-bold text-primary-700 mb-3 text-center">Solve & Submit</h3>
          <p class="text-gray-600">
            Work on the issue and submit your pull request. Our platform automatically tracks your PR on GitHub.
          </p>
          <div class="mt-4 text-sm text-gray-500">
            <span class="block">• Fork the repository</span>
            <span class="block">• Create a Pull Request</span>
            <span class="block">• Get review feedback</span>
          </div>
        </div>
      </div>
      ...
      <div class="relative">
        ...
        <div class="bg-white p-6 md:p-8 pt-12 rounded-xl shadow-md border border-gray-100 h-full relative z-0 hover:shadow-lg transition-shadow duration-300">
          ...
          <h3 class="text-xl font-bold text-blue-900 mb-3 text-center">Get Paid in Bitcoin</h3>
          <p class="text-gray-600">
            Once your PR is accepted, receive the bounty instantly to your Lightning wallet. No delays, no transaction fees.
          </p>
          <div class="mt-4 text-sm text-gray-500">
            <span class="block">• Instant Lightning payments</span>
            <span class="block">• Build your payment history</span>
            <span class="block">• Find your next bounty</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <!-- Testimonial -->
    <div class="mt-12 md:mt-16 bg-white p-6 md:p-8 rounded-xl shadow-md border border-gray-100 hover:shadow-lg transition-shadow duration-300">
      <div class="flex flex-col md:flex-row gap-6 items-center">
        ...
        <div class="flex-1">
          <div class="text-accent-500 flex mb-2">
          ...
          <blockquote class="text-gray-600 italic mb-2 text-lg">
          ...
          <div class="font-bold text-primary-800">Alex Rodriguez</div>
          <div class="text-sm text-gray-500">Full Stack Developer • 26 completed bounties</div>
        </div>
      </div>
    </div>
  </div>
